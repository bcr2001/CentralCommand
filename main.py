...
def rejection():
    ...
    wUsername_label = Label(rejectionWindow,text="Access Denied",image=wUsername_Image,compound=RIGHT,bg="white",font=("Dubai",20,"bold"))
...
def logInHandler():
    ...
    infoFileOpener = open("C:\\Users\\Hx101X\\Desktop\\informationFile\\user1.txt","r")
...
def mainTkinterWindow():
    ...
    myMainWindow.iconphoto(False, PhotoImage(file="C:\\Users\\Hx101X\\Desktop\\passwordManager\\Images\\password.png"))
    ...
    logIn_Button = Button(myMainWindow,text="log in",font=("Tahoma"),bg="black",fg="white",image=logIn_image,compound=RIGHT,borderwidth=0,activebackground="black",activeforeground="white",cursor="hand2",command=logInHandler)
